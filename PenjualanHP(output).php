...
<body>
    ...
    // validasi dan menampilkan ID Customer
    if (strlen($ID) == 0)
    ...
    ?><br>
    Email &nbsp : <?php
    // validasi dan menampilkan email
    ...
    ?><br>
    Alamat &nbsp : <?php
    // validasi dan menampilkan alamat
    if (strlen($alamat) == 0)
    ...
    Diskon Member &nbsp : <?php echo $diskon ?><br>
